...
INSERT INTO USUARIO (USERNAME, PASSWORD, ADMIN) VALUES ('admin', '{noop}admin', true);
INSERT INTO USUARIO (USERNAME, PASSWORD, ADMIN) VALUES ('cliente', '{noop}1234', false);
INSERT INTO USUARIO (USERNAME, PASSWORD, ADMIN) VALUES ('user2', '{noop}1234', false);

INSERT INTO CLIENTE (ID, NOMBRE, APELLIDOS, TELEFONO, DIRECCION, NUMERO_TARJETA, EMAIL) 
VALUES ((SELECT ID FROM USUARIO WHERE USERNAME='cliente'), 'Alvaro', 'Lorente', '767676776', 'PLAZA PEDRO', '2345322342', 'ejemplo@gmail.com');

INSERT INTO CATEGORIA (NOMBRE, DESTACADA, IMAGEN) VALUES ('Componentes', true, '');
INSERT INTO CATEGORIA (NOMBRE, DESTACADA, IMAGEN) VALUES ('Barcos', false, '');
INSERT INTO CATEGORIA (NOMBRE, DESTACADA, IMAGEN) VALUES ('Ropa deportiva', false, '');
...
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Orza y timón', 'Sirve para controlar la direccion del bote', 35, 0, 'https://www.empacher.com/fileadmin/EN/products/racing-boats/racing-four/Steuer_unter_Deck__steering_device_integrated_inside_canvas.JPG', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Componentes'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Dos sin', 'Bote de dos remeros con un remo cada uno', 2300, 0, 'https://www.empacher.com/fileadmin/EN/products/racing-boats/empacher-racing-double-nzl.jpg', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Barcos'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Skiff', 'Bote individual', 1000, 0, 'https://www.empacher.com/fileadmin/EN/products/racing-boats/empacher-racing-single.jpg', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Barcos'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Cuatro sin', 'Bote de cuatro remeros con un remo cada uno', 3400, 0.2, 'https://www.empacher.com/fileadmin/EN/products/racing-boats/empacher-racing-four-gbr.jpg', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Barcos'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('8+', 'Bote de ocho remeros con un remo cada uno', 7000, 0, 'https://img.nauticexpo.es/images_ne/photo-g/22344-10176238.jpg', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Barcos'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Camiseta térmica', 'Camiseta de licra para poder desarrollar un buen entrenamiento', 35, 0, 'https://media.futbolmania.com/media/catalog/product/cache/1/image/0f330055bc18e2dda592b4a7c3a0ea22/c/w/cw9488_imagen-de-la-camiseta-manga-larga-adidas-alphaskin-azul_1_frontal.jpg', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Ropa deportiva'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Remo', 'Nos proporciona la fuerza para el movimiento del bote', 150, 0.1, 'https://www.empacher.com/fileadmin/EN/products/oars/oar_bags.JPG', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Componentes'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Orza', 'Es la estructura donde van colocados los remos', 230, 0, 'https://www.empacher.com/fileadmin/EN/products/racing-boats/racing-four/Carbonflosse.JPG', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Componentes'));
INSERT INTO PRODUCTO (NOMBRE, DESCRIPCION, PVP, DESCUENTO, IMAGEN, CATEGORIA_ID) 
VALUES ('Platanito', 'Prenda elástica y transpirable', 50, 0, 'https://tienda.austral.es/labradoresrc/img/p/1/4/8/1/5/14815-large_default.jpg', 
(SELECT ID FROM CATEGORIA WHERE NOMBRE='Ropa deportiva'));
